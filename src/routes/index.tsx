    ...
    <div className="min-h-screen bg-night text-white overflow-hidden">
      ...
      <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-display text-xl font-bold tracking-tight">Solaris</span>
        </Link>
        <div className="hidden items-center gap-8 md:flex">
          <a href="#features" className="text-sm text-white/70 hover:text-white">Recursos</a>
          <a href="#how" className="text-sm text-white/70 hover:text-white">Como funciona</a>
          <a href="#pricing" className="text-sm text-white/70 hover:text-white">Planos</a>
        </div>
        <div className="flex items-center gap-3">
          <Link to="/auth/login" className="text-sm text-white/80 hover:text-white">Entrar</Link>
          <Link
      ...
      {/* HERO */}
      <section className="bg-solaris-hero relative">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 pb-32 pt-20 lg:grid-cols-2 lg:items-center lg:pt-28">
          <div>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              <Link
                to="/auth/register-doctor"
                className="group inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-3.5 font-medium text-primary-foreground shadow-glow transition hover:bg-primary-hover"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-6 py-3.5 font-medium text-white backdrop-blur transition hover:bg-white/10"
              >
                Sou paciente
              </Link>
            </div>
          ...
          <div className="relative mx-auto w-full max-w-sm">
            ...
            <div className="relative aspect-[9/19] rounded-[2.5rem] border-[10px] border-night bg-night shadow-2xl">
              <div className="h-full overflow-hidden rounded-[1.8rem] bg-gradient-to-b from-primary/90 to-primary-dark p-5">
      ...
      {/* FEATURES */}
      <section id="features" className="border-t border-white/5 bg-midnight py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 grid gap-px overflow-hidden rounded-3xl bg-white/5 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={f.title} className="group bg-night p-8 transition hover:bg-night/70">
      ...
      <section className="bg-night py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <Link
            to="/auth/register-doctor"
            className="mt-8 inline-flex items-center gap-2 rounded-xl bg-primary px-7 py-4 font-medium text-primary-foreground shadow-glow transition hover:bg-primary-hover"
          >
